 ...
 * 
 * @param {Object} props
 * @param {'text'|'card'|'avatar'|'table-row'} [props.variant='text'] - Skeleton type
...
export function SkeletonLoader({
  ...
  if (variant === 'table-row') {
    return React.createElement('div', {
      ...
      React.createElement('div', {
        style: { ...pulseStyle, height: '16px', width: '25%' },
      }),
      React.createElement('div', {
        style: { ...pulseStyle, height: '16px', width: '35%' },
      }),
      React.createElement('div', {
        style: { ...pulseStyle, height: '16px', width: '20%' },
      }),
      React.createElement('div', {
        style: { ...pulseStyle, height: '16px', width: '20%' },
      }),
